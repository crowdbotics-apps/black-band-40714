"""
Django settings for black_band_40714 project.
...
ROOT_URLCONF = 'black_band_40714.urls'
...
WSGI_APPLICATION = 'black_band_40714.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_band_40714 API",
    "DESCRIPTION": "API documentation for black_band_40714 App",
    "VERSION": "v1",
}
